    ...
    private:
        ...
        std::array<sparta::CycleCounter, N_STALL_REASONS> stall_counters_{{
                ...
                sparta::CycleCounter(getStatisticSet(), "stall_fpu_busy",
                                     "FPU busy",
                                     sparta::Counter::COUNT_NORMAL, getClock()),
                sparta::CycleCounter(getStatisticSet(), "stall_valu_busy",
                                     "VALU busy",
                                     sparta::Counter::COUNT_NORMAL, getClock()),
                sparta::CycleCounter(getStatisticSet(), "stall_vfpu_busy",
                                     "VFPU busy",
                                     sparta::Counter::COUNT_NORMAL, getClock()),
        ...
        unit_distribution_ {{
                ...
                sparta::Counter(getStatisticSet(), "count_valu_insts",
                                "Total VALU insts", sparta::Counter::COUNT_NORMAL),
                sparta::Counter(getStatisticSet(), "count_vfpu_insts",
                                "Total VFPU insts", sparta::Counter::COUNT_NORMAL),
